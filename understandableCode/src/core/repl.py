"""
UnderstandableCode REPL — Interactive programming environment.
...
class UnderstandableCodeREPL:
    """Interactive UnderstandableCode REPL."""
    ...
    def print_welcome(self):
        print()
        print("  ╔══════════════════════════════════════╗")
        print("  ║     UnderstandableCode REPL v1.0               ║")
    ...
    def print_help(self):
        print()
        print("  UnderstandableCode REPL Commands:")
        print("  ------------------------")
        print("  exit, quit    — Exit the REPL")
        print("  help           — Show this help")
        print("  vars           — Show defined variables")
        print("  clear          — Clear screen")
        print("  <any code>     — Type UnderstandableCode code directly")
        print()
    ...
    def execute(self, code: str):
        """Compile and run a single line or block of UnderstandableCode code."""
        try:
            # Lex
                ...
                if code.strip() == "vars":
                    ...
                    for k, v in sorted(self.globals.items()):
                        if not k.startswith("_") and k not in (
                            "__builtins__", "UnderstandableCode_input",
