# Tensor and Matrix Library for UnderstandableCode ML Workflows

This library adds a small, readable tensor and matrix toolkit to UnderstandableCode so experiments can start without depending on NumPy.
